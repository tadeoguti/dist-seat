...
const { obtenerIPPorMarca } = require('../../../../repository/ip.repository');
//const fetch = require("node-fetch");

async function validarIP(marca, dominio) {
    let resultado = {
        ipResuelta: null,
    ...
    try {
        ...
        // Comparar con la IP registrada en la base de datos
        const ipBD = await obtenerIPPorMarca(marca);
        resultado.coincideServidor = ips.address === ipBD;
